                        ...
                        <table class="shop_table cart">
                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-remove">
                                    <a href="{{route('item.delete', ['id' => $product->rowId])}}" class="product-del remove" title="Remove this item">
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        <a href="#">
                                            <img src="/{{$product->model->image}}" alt="product" width="100px" height="100px">
                                        </a>
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        <a href="{{route('item.reduce', ['id' => $product->rowId, 'qty' => $product->qty])}}" class="quantity-minus">-</a>
                                        <input title="Qty" class="email input-text qty text" value="{{$product->qty}}" type="text" placeholder="1" readonly>
                                        <a href="{{route('item.increase', ['id' => $product->rowId, 'qty' => $product->qty])}}" class="quantity-plus">+</a>
                                    </div>
